"""Test module emetteur (A) (ping) vers module recepteur (B) (pong)
"""
...
def emission(message): #emisison et renvoi de la réussite 
...
while True :
    #--------reception ping--------
    message = attente_reception() 
    print('message _recu', message)
    
    #--------emission pong---------
    etat = 0
    while not etat : 
        etat = emission(message ) 
    print('état',etat)
    utime.sleep_ms(100)
